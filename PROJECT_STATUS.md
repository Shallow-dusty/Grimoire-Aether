...
- ⬜ 管家 (Butler) - 只能投与主人相同的票
- ⬜ 隐士 (Recluse) - 可能被视为邪恶/恶魔
...
### 已知限制
1. **角色能力**: 还有 8 个角色能力未实现（洗衣妇、图书馆员、调查员、掘墓人、守鸦人、管家、隐士、市长完整实现）
...
### 本次更新亮点 (2026-01-10)
1. ✅ 新增 6 个角色能力实现（处女、杀手、男爵、厨师、投毒者、僧侣）
...
### 当前状态
项目已完成 **92% 的核心功能**，可以进行大部分游戏场景的测试。下一步重点是**完成剩余 8 个角色能力**。
